...
public:
   ...
   */
  static void draw_rect(size_t x, size_t y, size_t width, size_t height,
                        uint32_t color);

  /**
   * @brief Draw a filled solid rectangle
   */
  static void fill_rect(size_t x, size_t y, size_t width, size_t height,
                        uint32_t color);

  /**
   * @brief Draw a filled solid circle (for macOS Aqua buttons & dots)
   */
  static void fill_circle(int32_t cx, int32_t cy, int32_t radius, uint32_t color);

  /**
   * @brief Draw a filled rounded rectangle (for macOS Aqua dock & windows)
   */
  static void fill_rounded_rect(int32_t x, int32_t y, uint32_t width, uint32_t height, uint32_t radius, uint32_t color);
  ...
  /**
   * @brief Swap local dirty rectangle from backbuffer to physical linear
   * framebuffer
   */
