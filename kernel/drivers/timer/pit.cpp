/**
 * @file pit.cpp
 * @brief Programmable Interval Timer (PIT 8254) Driver implementation for
 * Nebula OS
...
void PIT::init(uint32_t frequency_hz) {
  ...
  // Generator), 16-bit binary 0x36 = 00 11 011 0
...
uint64_t PIT::get_ticks() { return m_ticks; }

uint32_t PIT::get_frequency() { return m_frequency; }
...
uint64_t pit_get_ticks() { return nebula::drivers::PIT::get_ticks(); }
