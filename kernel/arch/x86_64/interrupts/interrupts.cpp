...
void isr_handler(nebula::arch::x86_64::registers_t* regs) {
    ...
    uint8_t int_no = static_cast<uint8_t>(regs->int_no);

    if (nebula::arch::x86_64::interrupt_handlers[int_no] != nullptr) {
        nebula::arch::x86_64::interrupt_handlers[int_no](regs);
    } else {
...
void irq_handler(nebula::arch::x86_64::registers_t* regs) {
    ...
    nebula::arch::x86_64::PIC::send_eoi(irq_no);
}
